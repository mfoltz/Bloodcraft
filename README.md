...
### Weapon Expertise
- Gain levels in various weapon types by using them.
...
- Stat bonus values scale with player expertise level.
  - classes have synergies with certain stats (see Classes section)
