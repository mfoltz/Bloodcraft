...
(5/30) README NEEDS UPDATING, PRESTIGE AND FAMILIARS ADDED BUT EXPECT BUGS IF YOU TURN THEM ON, DIDN'T PUSH TO THUNDERSTORE YET FOR A REASON :P (quest skip command works great though)
