...
UPDATED (7/1)
(haven't figured out how to make a fancy button for Patreon yet so putting that here for now: patreon.com/zfolmt)
...
- `.removeFamiliar [#]`
  ...
  - Shortcut: *.rf [#]*
- `.familiarEmotes`
  - Toggles emote commands for familiars.
  - Shortcut: *.fe*
- `.listEmoteActions`
