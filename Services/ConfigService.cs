...
public static class ConfigService
{
    ...
    public static class ConfigInitialization
    {
        ...
        [
            ...
            new ConfigEntryDefinition("Familiars", "TraitChance", 0.2f, "The chance for a trait when unlocking familiars for the first time."),
            ...
            new ConfigEntryDefinition("Familiars", "ShinyChance", 0.2f, "The chance for a shiny when unlocking familiars for the first time (6 total, 1 per familiar). Second unlock of same unit guarantees a shiny, chance on damage dealt (same as configured onHitEffect chance) to apply spell school debuff."),
