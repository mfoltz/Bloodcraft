...
internal static class Core
{
    ...
    public static void Initialize()
    {
        ...
        if (!_elitePrimalRifts) Server.GetExistingSystemManaged<PrimalWarEventSystem>().Enabled = false;
    ...
    public static void DumpComponent(this ComponentType component, World world)
    {
