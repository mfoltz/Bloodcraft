...
namespace Bloodcraft.Commands
{
    ...
    internal static class PartyCommands
    {
        ...
        [Command(name: "toggleinvites", shortHand: "toginv", adminOnly: false, usage: ".party toginv", description: "Toggles being able to be invited to parties, prevents damage and share exp.")]
