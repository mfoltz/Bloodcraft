...
namespace Cobalt.Systems.Bloodline
{
    public class BloodMasterySystem
    {
        ...
        public static void UpdateBloodMastery(Entity Killer, Entity Victim)
        {
            ...
            {
                ServerChatUtils.SendSystemMessageToClient(entityManager, User, $"+<color=yellow>{BloodValue}</color> <color=red>sanguimancy</color>");
            }
        ...
        {
            if (!DataStructures.PlayerBloodStats.TryGetValue(steamId, out PlayerBloodlineStats bloodStats))
            {
        ...
        public static void SetBlood(ulong SteamID, int Value)
        {
            ...
            if (isPlayerFound)
            {
                if (Value + Mastery.Key > MaxBloodline)
                {
                    ...
                    DataStructures.PlayerCombatMastery[SteamID] = BloodMastery;
                }
                else
                {
            ...
            else
            {
                ...
                DataStructures.PlayerCombatMastery.Add(SteamID, BloodMastery);
            }
